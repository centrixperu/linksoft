...
!function(e){
	e.fn.imageUploader=function(t){
		let n,i = {
			...
			label: "Arrastra y suelta archivos aquí o haz clic para navegar", // "Drag & Drop files here or click to browse",
		...
		l = function(t,i,o) {
			...
			r=(e("<img>",{
				...
				// LKS - Se agrego animacion en la clase
				class:"delete-image animated rubberBand"
			}).appendTo(l));
			e("<i>",{
				class:"iui-close"
			}).appendTo(r);
			if(o){
				...
				e("<input>",{
					type:"hidden",name:a.settings.preloadedInputName+"[]",
					value:i
				}).appendTo(l)
